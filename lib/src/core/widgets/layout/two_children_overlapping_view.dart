    ...
    switch (priority) {
      case TwoChildrenOverlappingPriority.first:
        ...
        lastChild!.layout(
          constraints.copyWith(
              minHeight: 0.0,
              maxHeight: constraints.maxHeight - firstChild!.size.height + gap),
          parentUsesSize: true,
        );
      case TwoChildrenOverlappingPriority.second:
        ...
        firstChild!.layout(
          constraints.copyWith(
              minHeight: 0.0,
              maxHeight: constraints.maxHeight - lastChild!.size.height + gap),
          parentUsesSize: true,
        );
    }
    ((firstChild as RenderBox).parentData as TwoChildSizedData).offset =
        Offset.zero;
    ((lastChild as RenderBox).parentData as TwoChildSizedData).offset =
