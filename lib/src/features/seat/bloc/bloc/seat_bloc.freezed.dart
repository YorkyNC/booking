...
class __$$GetHistoryImplCopyWithImpl<$Res>
    extends _$SeatEventCopyWithImpl<$Res, _$GetHistoryImpl>
...
class _$GetHistoryImpl implements _GetHistory {
  ...
  @override
  String toString() {
    return 'SeatEvent.getHistory(request: $request)';
  }
...
abstract class _GetHistory implements SeatEvent {
...
/// @nodoc
abstract class _$$RepeatLastImplCopyWith<$Res> {
  factory _$$RepeatLastImplCopyWith(
          _$RepeatLastImpl value, $Res Function(_$RepeatLastImpl) then) =
      __$$RepeatLastImplCopyWithImpl<$Res>;
  @useResult
  $Res call({RepeatLastRequest request});

  $RepeatLastRequestCopyWith<$Res> get request;
}

/// @nodoc
class __$$RepeatLastImplCopyWithImpl<$Res>
    extends _$SeatEventCopyWithImpl<$Res, _$RepeatLastImpl>
    implements _$$RepeatLastImplCopyWith<$Res> {
  __$$RepeatLastImplCopyWithImpl(
      _$RepeatLastImpl _value, $Res Function(_$RepeatLastImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RepeatLastImpl(
      null == request
          ? _value.request
          : request // ignore: cast_nullable_to_non_nullable
              as RepeatLastRequest,
    ));
  }
  ...
  @pragma('vm:prefer-inline')
  $RepeatLastRequestCopyWith<$Res> get request {
    return $RepeatLastRequestCopyWith<$Res>(_value.request, (value) {
      return _then(_value.copyWith(request: value));
    });
  }
}
...
class _$RepeatLastImpl implements _RepeatLast {
  const _$RepeatLastImpl(this.request);

  @override
  final RepeatLastRequest request;

  @override
  String toString() {
    return 'SeatEvent.repeatLast(request: $request)';
  }
  ...
  _$$RepeatLastImplCopyWith<_$RepeatLastImpl> get copyWith =>
      __$$RepeatLastImplCopyWithImpl<_$RepeatLastImpl>(this, _$identity);
...
abstract class _RepeatLast implements SeatEvent {
  const factory _RepeatLast(final RepeatLastRequest request) = _$RepeatLastImpl;

  RepeatLastRequest get request;
...
mixin _$SeatViewModel {
  ...
  CreateReservationEntity? get reservation =>
      throw _privateConstructorUsedError;
  GetHistoryList? get history => throw _privateConstructorUsedError;
...
abstract class $SeatViewModelCopyWith<$Res> {
  ...
  $GetHistoryListCopyWith<$Res>? get history;
}
...
class _$SeatViewModelCopyWithImpl<$Res, $Val extends SeatViewModel>
  ...
  $GetHistoryListCopyWith<$Res>? get history {
    ...
    return $GetHistoryListCopyWith<$Res>(_value.history!, (value) {
...
class _$SeatViewModelImpl implements _SeatViewModel {
  const _$SeatViewModelImpl(
      {this.allSeat, this.seat, this.reservation, this.history});
  ...
  @override
  final GetHistoryList? history;

  @override
  String toString() {
    return 'SeatViewModel(allSeat: $allSeat, seat: $seat, reservation: $reservation, history: $history)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, allSeat, seat, reservation, history);
...
abstract class _SeatViewModel implements SeatViewModel {
  const factory _SeatViewModel(
      ...
      final SeatItemEntity? seat,
      final CreateReservationEntity? reservation,
      final GetHistoryList? history}) = _$SeatViewModelImpl;
